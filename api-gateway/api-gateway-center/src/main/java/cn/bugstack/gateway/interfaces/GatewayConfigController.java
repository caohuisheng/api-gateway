...
public class GatewayConfigController {
    ...
    public Result<Boolean> distributionGatewayServerNode(@RequestParam String groupId, @RequestParam String gatewayId,@RequestParam String systemId){
        try {
            log.info("网关算力与系统挂载配置 groupId:{} gatewayId:{} systemId:{}",groupId, gatewayId, systemId);
            ...
            log.info("网关算力与系统挂载配置异常 groupId:{} gatewayId:{} systemId:{}",groupId, gatewayId, systemId,e);
