...
public class ConfigManageRepository implements IConfigManageRepository {
    ...
    @Override
    public ApplicationSystem queryApplicationSystemById(String systemId) {
        return applicationSystemDao.queryApplicationSystemById(systemId);
    }

    @Override
    public void distributionGatewayServerNode(String groupId, String gatewayId, String systemId, String systemName) {
        GatewayDistributionVO gatewayDistributionVO = new GatewayDistributionVO();
        gatewayDistributionVO.setGroupId(groupId);
        gatewayDistributionVO.setGatewayId(gatewayId);
        gatewayDistributionVO.setSystemId(systemId);
        gatewayDistributionVO.setSystemName(systemName);
        gatewayDistributionDao.insert(gatewayDistributionVO);
    }
}
