...
import cn.bugstack.gateway.datasource.connection.HttpConnection;
...
public abstract class BaseExecutor implements Executor{
    ...
    @Override
    public GatewayResult exec(HttpStatement httpStatement, Map<String, Object> params) throws RuntimeException {
